...
describe('form data factory', function() {
  describe('basic functionality', function() {
    ...
    it('should be able to get all formData values', function() {
      ...
      expect(helpers.getInitial(formData)).to.deep.equal({
        firstName: 'initial',
        lastName: '',
        email: '',
        password: '',
    ...
    it('should be able to set specific initial value', function() {
      var formData = formDataFactory(configInitialValue);
    ...
    it('should be able to clear all formData values', function() {
      var formData = formDataFactory(configAllInitialValues);
      ...
      formData = helpers.clear(formData);
    ...
    it('should be able to clear and reset initial values for all fields', function() {
      var formData = formDataFactory(configAllInitialValues);
      ...
      formData = helpers.clear(formData, true);
    ...
    it('should be able to reset 1 field with new initial values', function() {
      var formData = formDataFactory(configInitialValue);
      ...
      formData = helpers.resetWithData(formData, 'firstName', 'f');
      ...
      expect(formData.getIn(['firstName', 'initialValue'])).to.equal('f');
      expect(formData.getIn(['lastName', 'initialValue'])).to.equal('');
      expect(formData.getIn(['email', 'initialValue'])).to.equal('');
      expect(formData.getIn(['password', 'initialValue'])).to.equal('');
      expect(formData.getIn(['confirmPassword', 'initialValue'])).to.equal('');
    });

    it('should be able to reset with new initial values', function() {
      var formData = formDataFactory(configInitialValue);
      ...
      formData = helpers.resetWithData(formData, {
        firstName: 'f',
        lastName: 'l',
        email: 'e',
        password: 'p',
      ...
      expect(formData.getIn(['firstName', 'initialValue'])).to.equal('f');
      expect(formData.getIn(['lastName', 'initialValue'])).to.equal('l');
      expect(formData.getIn(['email', 'initialValue'])).to.equal('e');
      expect(formData.getIn(['password', 'initialValue'])).to.equal('p');
      expect(formData.getIn(['confirmPassword', 'initialValue'])).to.equal('c');
    });
